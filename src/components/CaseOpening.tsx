...
const cases: Case[] = [
  {
    ...
    items: [
      { id: '1', name: 'Neon Glock', rarity: 'common', image: 'https://images.unsplash.com/photo-1595590424283-b8f17842773f?w=200', chance: 40 },
      { id: '2', name: 'Cyber AK-47', rarity: 'rare', image: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=200', chance: 30 },
      { id: '3', name: 'Plasma M4A4', rarity: 'epic', image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=200', chance: 20 },
      { id: '4', name: 'Dragon AWP', rarity: 'legendary', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200', chance: 10 },
    ],
  },
  {
    id: '2',
    ...
    items: [
      { id: '5', name: 'Fire Pistol', rarity: 'common', image: 'https://images.unsplash.com/photo-1595590424283-b8f17842773f?w=200', chance: 35 },
      { id: '6', name: 'Flame Rifle', rarity: 'rare', image: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=200', chance: 35 },
      { id: '7', name: 'Inferno Sniper', rarity: 'epic', image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=200', chance: 20 },
      { id: '8', name: 'Dragon Lore', rarity: 'legendary', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200', chance: 10 },
    ],
  },
  {
    id: '3',
    ...
    items: [
      { id: '9', name: 'Gold USP', rarity: 'rare', image: 'https://images.unsplash.com/photo-1595590424283-b8f17842773f?w=200', chance: 40 },
      { id: '10', name: 'Diamond AK', rarity: 'epic', image: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=200', chance: 35 },
      { id: '11', name: 'Platinum M4', rarity: 'epic', image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=200', chance: 20 },
      { id: '12', name: 'Howl Legendary', rarity: 'legendary', image: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=200', chance: 5 },
    ],
  },
];
